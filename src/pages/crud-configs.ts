...
export const cdpConfig: CrudResourceConfig = {
  ...
  fields: [
    ...
    number("valorSolicitado", "Valor solicitado", false),
    number("valorAprobado", "Valor aprobado"),
    number("valorComprometidoRp", "Valor comprometido RP", false),
    number("valorReintegrado", "Valor reintegrado"),
